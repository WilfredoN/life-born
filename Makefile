...
life-born: raylib
ifneq (,$(life_born_config))
	@echo "==== Building life-born ($(life_born_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f life-born.make config=$(life_born_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f life-born.make clean
